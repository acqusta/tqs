...
#pragma pack()
    ...
    */
    ...
    public:
        ...
        virtual void on_bar          (const char* cycle, shared_ptr<const Bar> bar) = 0;
    };
    ...
    public:   
        ...
        * @return
        */
        virtual CallResult<const vector<MarketQuote>> tick(const char* code, int trading_day) = 0;
        ...
        * @return
        */
        virtual CallResult<const vector<Bar>> bar(const char* code, const char* cycle, int trading_day, bool align) = 0;
        ...
        * @return
        */
        virtual CallResult<const vector<DailyBar>> daily_bar(const char* code, const char* price_adj, bool align) = 0;
        ...
        * @return
        */
        virtual CallResult<const MarketQuote> quote(const char* code) = 0;
...
#define SD_Short "Short"
    ...
    public:
        ...
        * @return
        */
        virtual CallResult<const Balance> query_balance(const char* account_id) = 0;
        ...
        * @return
        */
        virtual CallResult<const vector<Order>> query_orders(const char* account_id) = 0;
        ...
        * @return
        */
        virtual CallResult<const vector<Trade>> query_trades(const char* account_id) = 0;
        ...
        * @return
        */
        virtual CallResult<const vector<Position>> query_positions(const char* account_id) = 0;
        ...
        * @return OrderID      订单ID
        */
        virtual CallResult<const OrderID> place_order(const char* account_id, const char* code, double price, int64_t size, const char* action, int order_id) = 0;
